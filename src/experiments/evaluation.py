...
def compute_exact_results(p: Params, cache=True, recompute=True, subdir_name="", print_results=True):
    ...
    save_folder = EXACT_RESULTS_DIR + subdir_name + sanitise_path_string(
...
def load_multivec_index_from_params(params: Params, construction_params: MultiVecHNSWConstructionParams, subdir_name=""):
    ...
    index_save_folder = SAVED_INDEX_DIR + subdir_name + index_string
