...
def evaluate_weights_experiments(params, construction_params, experiment_dataset_sizes):
    ...
    for dataset_size in experiment_dataset_sizes:
        ...
        for k in [50]:
            ...
            for text_search_weight in experiment_search_weights:
                ...
                for ef_search in range(k, k + k*12, k):
...
def main():
    ...
    construction_params.target_degree = 32
    construction_params.max_degree = 32
    construction_params.ef_construction = 200
    construction_params.seed = 3

    dataset_sizes = [100_000]
    evaluate_weights_experiments(params, construction_params, dataset_sizes)
